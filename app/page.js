...
export default function MiniTalabat() {
  ...
  return (
    <div dir="rtl" style={{ padding: '10px', fontFamily: 'sans-serif', backgroundColor: '#121212', color: '#e0e0e0', minHeight: '100vh', paddingBottom: '110px' }}>
      ...
      {activeTab === 'addShop' && (
        <div style={{ padding: '20px', textAlign: 'center', position: 'relative', overflow: 'hidden', minHeight: '80vh' }}>
          
          {/* اللوجو في الخلفية بشكل كبير وخفيف جداً */}
          <img 
            src="/mall-logo.png" 
            alt="Watermark" 
            style={{ 
              ...
              width: '250px', 
              opacity: '0.05', // شفافية خفيفة جداً (5%)
              pointerEvents: 'none',
              zIndex: 0 
            }} 
          />
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ backgroundColor: 'rgba(30, 30, 30, 0.8)', padding: '20px', borderRadius: '15px', border: '1px dashed #FF6600' }}>
