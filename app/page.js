    ...
    <div dir="rtl" style={{ padding: '10px', fontFamily: 'sans-serif', backgroundColor: '#121212', color: '#e0e0e0', minHeight: '100vh', paddingBottom: '110px' }}>
      ...
      {activeTab === 'home' && (
        <>
          <header style={{ textAlign: 'center', marginBottom: '15px' }}>
            ...
            {/* الجملة اللي رجعت مكانها وبشكل شيك */}
      ...
      {activeTab === 'addShop' && (
        <div style={{ padding: '20px', textAlign: 'center' }}>
          ...
          <h2 style={{ color: '#FF6600' }}>انضم لمستقبل التجارة الرقمية</h2>
          <p style={{ lineHeight: '1.6', color: '#ccc', marginBottom: '30px', fontSize: '14px' }}>
            حوّل محلك لأبلكيشن في ثواني واوصل لكل الناس.<br/>
            في ميني طلبات، بنساعدك تكبر وتبيع أكتر!
          </p>
          <button 
